...
| Component | Status | Notes |
|---|---|---|
| `Tooltip` | **FROZEN** | Floating reference. |
| `Popover` | Planned | ← Floating. |
| `DropdownMenu` | Planned | ← Floating. |
